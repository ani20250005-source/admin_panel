  ...
  return (
    <div className="p-4 md:p-6 bg-gray-50 space-y-6">
      ...
      <div className="bg-white shadow rounded-md p-4 md:p-6 space-y-4">
        <h3 className="text-xl font-semibold border-b border-gray-300 pb-4">Saved Templates</h3>
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-3">
          {templates.map((t, i) => (
            <div key={i} className="bg-white border border-gray-300 rounded-lg p-3 hover:shadow">
