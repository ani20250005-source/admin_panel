...
const currentSeller = {
  shopname: "Shop.com",
  sellerName: "Sanjay Kumar",   // <-- SELLER NAME HERE
  city: "Baner, Pune",
  ...
  image: "https://www.bing.com/th/id/OIP.-2QdepLpzF3_krchZtFKpQHaE8?w=251&h=211&c=8&rs=1&qlt=90&o=6&cb=ucfimg1&dpr=1.3&pid=3.1&rm=2&ucfimg=1",
};

const productList = [
  { sku: "YHB826K98", name: "Fresh Organic Brinjals", price: 115, rating: 4.5, img: "https://www.bing.com/th/id/OIP.LRPVTH_fs6H_wr_Mqv9LpwHaFF?w=255&h=211&c=8&rs=1&qlt=90&o=6&cb=ucfimg1&dpr=1.3&pid=3.1&rm=2&ucfimg=1" },
  { sku: "YHB826K98", name: "Fresh Organic Tomatoes", price: 150, rating: 5.0, img: "https://th.bing.com/th/id/OIP.5hDg2YV-aJRD74mg8Bbk3AHaE8?w=160&h=108&c=7&qlt=90&bgcl=15e219&r=0&o=6&cb=ucfimg1&dpr=1.3&pid=13.1&ucfimg=1" },
  { sku: "YHB826K98", name: "Fresh Organic Potatoes", price: 100, rating: 4.0, img: "https://www.bing.com/th/id/OIP.VbmDVZoch2S1fXeq1f44qQHaE8?w=274&h=211&c=8&rs=1&qlt=90&o=6&cb=ucfimg1&dpr=1.3&pid=3.1&rm=2&ucfimg=1" },
  { sku: "YHB826K98", name: "Fresh Organic Cauliflower", price: 120, rating: 3.5, img: "https://cdn.pixabay.com/photo/2020/09/02/15/29/cauliflower-5538616_1280.jpg" },
  { sku: "YHB826K98", name: "Fresh Organic Green Chilli", price: 115, rating: 4.5, img: "https://th.bing.com/th/id/OIP.sjfw5Hkr2q3TAp3ssexfRwHaFj?w=249&h=187&c=7&r=0&o=7&cb=ucfimg2&dpr=1.3&pid=1.7&rm=3&ucfimg=1" },
  { sku: "YHB826K98", name: "Fresh Organic coriander leaves", price: 105, rating: 5.0, img: "https://www.bing.com/th/id/OIP.GlXiYHm_kKyXP-_PcrFNfwHaFj?w=246&h=211&c=8&rs=1&qlt=90&o=6&cb=ucfimg1&dpr=1.3&pid=3.1&rm=2&ucfimg=1" },
  { sku: "YHB826K98", name: "Fresh Organic Cabbage", price: 180, rating: 3.5, img: "https://www.bing.com/th/id/OIP.HmsYr-3DCI-7uRaXH0HnpQHaHa?w=188&h=211&c=8&rs=1&qlt=90&o=6&cb=ucfimg1&dpr=1.3&pid=3.1&rm=2&ucfimg=1" },
  { sku: "YHB826K98", name: "Fresh Organic Lady Fingers", price: 125, rating: 4.5, img: "https://www.bing.com/th/id/OIP.XrvravyNTlRnG2JqU01kewHaE8?w=255&h=211&c=8&rs=1&qlt=90&o=6&cb=ucfimg1&dpr=1.3&pid=3.1&rm=2&ucfimg=1" },
];

const reviewList = [
  { name: "Fresh Organic Potatoes", rating: 4.5, text: "Farm fresh...", img: "https://www.bing.com/th/id/OIP.VbmDVZoch2S1fXeq1f44qQHaE8?w=274&h=211&c=8&rs=1&qlt=90&o=6&cb=ucfimg1&dpr=1.3&pid=3.1&rm=2&ucfimg=1", by: "Green Valley Farm", date: "24 Nov 2025" },
  { name: "Fresh Organic Cabbage", rating: 4.0, text: "Excellent quality...", img: "https://www.bing.com/th/id/OIP.HmsYr-3DCI-7uRaXH0HnpQHaHa?w=188&h=211&c=8&rs=1&qlt=90&o=6&cb=ucfimg1&dpr=1.3&pid=3.1&rm=2&ucfimg=1", by: "Green Valley Farm", date: "24 Nov 2025" },
];
...
const ProductCard = ({ product }) => (
  <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition overflow-hidden flex flex-col">
    <img
      ...
      onError={(e) => {
        e.target.src = "https://placehold.co/200x120/E5E7EB/6B7280?text=No+Image";
      }}
    />
        ...
        <div className="bg-white p-6 rounded-xl shadow-xl border border-gray-100">
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-3 items-center mb-6 border-b  border-gray-200 pb-4">
            ...
            <div className="flex gap-2 bg-gray-200 rounded-full p-1 w-full sm:w-auto">
              <button className="px-4 py-2 text-sm font-medium bg-green-600 text-white rounded-full w-full sm:w-auto">Unblock</button>
              <button className="px-4 py-2 text-sm font-medium text-gray-700 rounded-full hover:bg-gray-300 w-full sm:w-auto">Block</button>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-6 pb-6 border-b border-gray-200 ">
            <div className="flex flex-1 gap-4">
              ...
              />
              <div>
                <h2 className="text-xl font-bold">{currentSeller.shopname}</h2>

                {/* SELLER NAME ADDED HERE */}
                <p className="text-sm font-medium text-gray-700">
                  Seller: {currentSeller.sellerName}
                </p>

                <p className="text-sm text-gray-500 mt-1">{currentSeller.city}</p>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-800">{currentSeller.sellerName}</p>
                  </div>

                  <div>
                    <p className="text-xs text-gray-500 uppercase">Store Name</p>
                    <p className="font-semibold text-gray-800">{currentSeller.shopname}</p>
                  </div>
              ...
              <div>
                <div className="flex flex-col sm:flex-row justify-between gap-3 mb-6">
                  <h3 className="text-xl font-bold">
                    All Products ({currentSeller.totalProducts})
                  </h3>
            ...
            {activeTab === "Payment" && (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                <div className="bg-white p-6 shadow rounded-xl border-t-4 border-[green]">
                  ...
                  <p className="text-sm">
                    Network: <span className="font-semibold">MTN Mobile Money</span>
                  </p>
                ...
                <div className="bg-white p-6 shadow rounded-xl border-t-4 border-[green]">
                  ...
                  <p className="text-sm mt-1">Name: {currentSeller.sellerName}</p>
                ...
                <div className="bg-white p-6 shadow rounded-xl border-t-4 border-[green] flex flex-col items-center text-center">
                  ...
                  <p className="text-xs text-gray-500">
                    Scan to pay Merchant: 4075800480
                  </p>
                </div>
